...
<body>
    ...
    <div class= "header">
      <div class= "name">こんにちは <?= $_SESSION["name"] ?> さん</div>
      <div class = "container">
        <div class = "mypage"><a href = "mypage.php">マイページ</a></div>
    ...
    <fieldset>
        ...
        <div class="item">
        <label class="label_left">捕獲個体の画像：<input type="file" name="image" accept="image/jpeg, image/png" multiple required><br></label><br>
        </div>
